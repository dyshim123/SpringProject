...
//		if(result == 0) {
			...
			/*
			 * UserVo vos = new UserVo(); vos.setuId(vo.getuId());
			 * vos.setuName(vo.getuName()); vos.setuAge(vo.getuAge());
			 * vos.setuPhone(vo.getuPhone()); vos.setuEmail(vo.getuEmail());
			 */
				userService.updateUserVo(vo);
			} catch (UserException e) {
				System.err.println("여기로 오긴 하는겨?");
				e.printStackTrace();
			}
