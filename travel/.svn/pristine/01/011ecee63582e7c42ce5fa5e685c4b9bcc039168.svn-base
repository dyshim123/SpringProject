	...
	<div class="container">
		<form method="post" action="contentForm.do" name="writeform" enctype="multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" style="width: 70%" name="bTitle" id="bTitle" required="required" value="${result.bTitle}">
				</div>
			</div>
			<br>
			<br>
					...
					<div id="profile-upload">
						<div class="hvr-profile-img">
							<input type="file" class="upload w180" name="bPic1" id="bPic1"
								title="Dimensions 180 X 180" value="/image/${result.bPic1}"
			...
			<br>
			<script>
		    var bCate = "${result.bCate}";
		    
		    $(document).ready(function () {
		    	  $('option[value=' + bCate + ']').attr('selected', 'selected');
		    	});
			...
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<select name="bCate" id="selectBox">
		    ...
		    var bLo = "${result.bLo}";
		    $(document).ready(function () {
		    	  $('input[value=' + bLo + ']').attr('checked', 'checked');
		    	});
			</script>
			<div class="form-group row">
			...
			<br> <script>
		    var bOne = "${result.bOne}";
		    $(document).ready(function () {
		    	  $('input[value=' + bOne + ']').attr('checked', 'checked');
		    	});
			</script>
				<script>
				function toggle(box, d1, d2) {
				 ...
				 var bTr = "${result.bTr}";
				    $(document).ready(function () {
				    	$('option[value=' + bTr + ']').attr('selected', 'selected');
				    	});
			</script>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-1">
					<input type="text" size="50" maxlength="50" name="bDay1"
						id="b_day1" required="required" value="${result.bDay1}">
				</div>
				<div class="pp">박</div>
				<div class="col-sm-1">
					<input type="text" size="50" maxlength="50" name="bDay2"
						id="b_day2" required="required" value="${result.bDay2}">
				</div>
				<div class="col-sm-1">
					<div class="pp">일</div>
				</div>
        ...
        <script>
 		$(document).ready(function() {
			...
			<div class="but" style="text-align: center;">
				<button id="sub" class="btn btn-ff btn-block">등록</button> <a
					href="#" class="button alt">삭제</a>
			</div>
		</form>
		<br>
